...
export function PlantList(props) {
    ...
    return (
        <div>
            ...
            <h2 className="explore-subheading">Search for different species of houseplants in our houseplant index and click the cards below to learn more about each plant!</h2>
